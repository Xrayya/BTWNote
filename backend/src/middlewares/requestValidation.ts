import type { RequestSchema } from "@/schemas/validation/RequestSchema";
...
>(
  schema: RequestSchema<TJson, TQuery, THeader, TParams, TCookie, TForm>
) => {
